...
public:
    ...
    static constexpr int WIN_LEN = 8;
    ...
    const std::vector<std::vector<char>>& raw() const { return grid; }

private:
    std::vector<std::vector<char>> grid;  // ADT #1: 2D vector for the 50x50 board
